...
**ANSWER: 1(0) is FALSE and (1)(0)' is TRUE**
...
**ANSWER: 1+0 is TRUE (1 or 0). !(true||false) is false (NOT 1 or 0)**
...
**ANSWER: true^false is TRUE since only one is false. !(false^false) is TRUE, since both are false, but its the inverse**
